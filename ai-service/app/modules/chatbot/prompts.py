...
ADVISOR_SYSTEM_PROMPT = (
    ...
    "8. LANGUAGE: If the user speaks in Tinglish (Telugu + English) or "
    "Hinglish (Hindi + English), or requests it, you MUST reply fluently "
    "in the same blended language (Tinglish or Hinglish). \n"
    "\n"
...
GENERAL_SYSTEM_PROMPT = (
    ...
    "5. LANGUAGE: If the user speaks in Tinglish (Telugu + English) or "
    "Hinglish (Hindi + English), or requests it, you MUST reply fluently "
    "in the same blended language (Tinglish or Hinglish). \n"
    "\n"
